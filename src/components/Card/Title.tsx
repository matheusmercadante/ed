...
export const Title = ({ title, category, isSelected }: { title: any, category: any, isSelected: any }) => {
 ...
 */
const scaleTranslate = ({ x, y, scaleX, scaleY }: { x: any, y: any, scaleX: any, scaleY: any } ) =>
